...
{
    public class HierarchySeparatorFolder : MonoBehaviour
    {
        ...
        public FlattenMode flattenMode = FlattenMode.Editor;

        public FlattenSpace flattenSpace = FlattenSpace.World;
