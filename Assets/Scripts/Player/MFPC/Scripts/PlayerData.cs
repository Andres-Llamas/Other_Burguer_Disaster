...
namespace MFPC
{
    ...
    public class PlayerData : ScriptableObject
    {
        ...
        [Docs("When enabled, then the player can Move in the air.")]
        [field: SerializeField]
        public bool MoveOnAir { get; private set; } = true;
        ...
        [Docs("Uses cinemachine or normal camera")]
        [field: SerializeField]
        public bool UsingCinemachine { get; private set; }
        #endregion
        ...
        [Docs("Delay time of the transition between grounded and not grounded ")]
        [field: SerializeField]
        public float CoyoteTime { get; private set; } = 0.5f;

        [Docs("Do not touch this. For testing proposes only ")]
        [field: SerializeField]
